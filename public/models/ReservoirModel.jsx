...
Command: npx gltfjsx@6.1.4 ReservoirModel.glb
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/ReservoirModel.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Wellhead002.geometry} material={materials['Case.005']} position={[-6.42, 32.44, 16.94]} rotation={[0, Math.PI / 2, 0]} scale={0.44}>
        ...
        <mesh geometry={nodes.Cylinder010_1.geometry} material={materials['Case.005']} position={[4.52, 14.47, 0.09]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={1.16} />
      ...
      <mesh geometry={nodes.Wellhead004.geometry} material={materials['Case.005']} position={[19.21, 32.44, 16.94]} rotation={[0, Math.PI / 2, 0]} scale={0.44}>
        ...
        <mesh geometry={nodes.Cylinder126_1.geometry} material={materials['Case.005']} position={[-0.09, 6.23, 0.12]} scale={4.41} />
        <mesh geometry={nodes.Cylinder127_1.geometry} material={materials['Case.005']} position={[-0.09, 12.61, 0.19]} rotation={[-3.14, 0, 0]} scale={[2.21, 0.29, 2.21]} />
...
useGLTF.preload('/ReservoirModel.glb')
